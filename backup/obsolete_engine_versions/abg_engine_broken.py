...
result["primary_disorder"] = disorder
...
if disorder == "Metabolic Acidosis":
            ...
            report.append(
               f"Expected PaCO2 (Winter): {expected:.1f}"
            )
...
result["compensation"] = mixed_result
...
result["anion_gap_value"] = ag
        if na is not None and cl is not None:
            ...
            if ag > 12:
                ...
                result["anion_gap"] = "High"
            else:
                report.append("Normal Anion Gap")
                result["anion_gap"] = "Normal"
